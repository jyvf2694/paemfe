 ...
 * @endcode
 */
$settings['hash_salt'] = 'PcH8DqLbb0Z98jmLk4_mEGV50QIgzFMsxZXNlagtiMPR4dyncYZDtqb8YRswUIc6xlOyBynvlg';
 ...
 */
  $settings['trusted_host_patterns'] = [
    '^www\.paemfe\.edu\.uy$','^t2\.anep\.edu\.uy$','^.paemfe\.edu\.uy$','^www2\.paemfe\.edu\.uy$',
  ];
...
$settings['config_sync_directory'] = 'sites/default/files/config_T8SGXHrg_N85gBYIe2dyZ5xomirimIjdUo3bXH8n5MbQvj6AaAU7FxwgzddDXK2wEH9UpnCyoA/sync';
