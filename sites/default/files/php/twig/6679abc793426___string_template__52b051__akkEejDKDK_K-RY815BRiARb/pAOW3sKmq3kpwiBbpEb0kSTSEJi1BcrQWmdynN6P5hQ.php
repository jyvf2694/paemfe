...
class __TwigTemplate_a192cee21be9e4e8fcbb937e9b42a4ce extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}{{ release_version }} (<a href=\"{{ release_link }}\" title=\"{{ project_title }}\">{{ release_notes }}</a>)<div title=\"{{ major_update_warning_title }}\" class=\"update-major-version-warning\">{{ major_update_warning_text }}</div>", "__string_template__52b051bf473c5ca55c5745fe043cdb72", "");
    }
