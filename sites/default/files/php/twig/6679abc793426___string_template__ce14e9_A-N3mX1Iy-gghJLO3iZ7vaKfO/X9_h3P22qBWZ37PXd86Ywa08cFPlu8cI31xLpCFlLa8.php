...
class __TwigTemplate_7863a16d612d1add3812d216240ca60f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}{{ release_version }} (<a href=\"{{ release_link }}\" title=\"{{ project_title }}\">{{ release_notes }}</a>) <div>{{ core_compatibility_message }}</div>", "__string_template__ce14e959d762d5a8b41c69576bb5fb68", "");
    }
